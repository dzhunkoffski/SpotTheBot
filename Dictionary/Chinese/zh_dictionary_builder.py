...
def create_table(data_vectorized, k, table_path, name):
    ...
    with open('zh_u_1024.npy', 'wb') as f:
        np.save(f, u)
    with open('zh_sig_1024.npy', 'wb') as f:
        np.save(f, sigma)
    with open('zh_vt_1024.npy', 'wb') as f:
        np.save(f, vt)
...
with open('zh_data_vectorized.npy', 'wb') as f:
    np.save(f, zh_data_vectorized)
